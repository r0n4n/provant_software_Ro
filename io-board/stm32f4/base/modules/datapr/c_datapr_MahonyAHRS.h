...
void c_datapr_MahonyAHRSupdate(float * q, float * velAngular_corrigida, float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz, long sample_time_gyro_us);
