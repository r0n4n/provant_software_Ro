...
//  a=tau/(tau+IntegrationTimeDiff);
  a=tau/(tau+sample_time);

  rpy[PV_IMU_ROLL  ] =  a*(last_rpy[PV_IMU_ROLL ] + gyro_filtro[PV_IMU_ROLL ]*sample_time) + (1.0f - a)*acce_rpy[PV_IMU_ROLL ];
  rpy[PV_IMU_PITCH ] =  a*(last_rpy[PV_IMU_PITCH] + gyro_filtro[PV_IMU_PITCH]*sample_time) + (1.0f - a)*acce_rpy[PV_IMU_PITCH];
...
//	float acce_raw[3], gyro_raw[3], magn_raw[3], sample_time;
...
//
//	//c_io_imu_getRaw(acce_raw, gyro_raw, magn_raw, sample_time);
